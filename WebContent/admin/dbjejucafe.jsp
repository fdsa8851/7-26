...
<%
	...
	ArrayList<CafeVO> getList = CafeDAO.getCafe();
...
<script>
	function getUserInfo() {
		...
		$.ajax({
			type : 'POST',
			url : path + "/getcafeinfo.JejuTravel",
			data : {
				"u_idx" : u_idx
			},
	...
	function updateInfo() {
		...
		$.ajax({
			type : 'POST',
			url : path + "/cafeupdateinfo.JejuTravel",
			data : {
				"u_idx" : u_idx,
				"address" : address,
				"name" : name,
	...
	function delInfo() {
		...
		$.ajax({
			type : 'POST',
			url : path + '/delcafeinfo.JejuTravel',
			data : {
				"u_idx" : u_idx
			},
			success : function(data) {
