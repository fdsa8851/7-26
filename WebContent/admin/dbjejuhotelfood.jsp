...
<%
	...
	ArrayList<HotelVO> getList = HotelDAO.getHotelFood();
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="email">식당이름</label> <input type="text"
								class="form-control" id="name">
						</div>
						<div class="form-group">
							<label for="phone">영업시간</label> <input type="text"
								class="form-control" id="bHours">
						</div>
										<div class="form-group">
						<label for="pwd">추천음식</label> <input type="text"
							class="form-control" id="food">
						<div class="form-group">
							<label for="pwd">휴무</label> <input type="text"
...
<script>
	function getUserInfo() {
		...
		$.ajax({
			type : 'POST',
			url : path + "/gethotelinfo.JejuTravel",
	...
	function updateInfo() {
		...
		$.ajax({
			type : 'POST',
			url : path + "/hotelupdateinfo.JejuTravel",
			data : {
				"u_idx" : u_idx,
				"address" : address,
				"name" : name,
	...
	function delInfo() {
		...
		$.ajax({
			type : 'POST',
			url : path + '/delhotelinfo.JejuTravel',
			data : {
				"u_idx" : u_idx
			},
			success : function(data) {
