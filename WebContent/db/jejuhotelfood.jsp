	...
	<body>
		...
		<div class="container">
			<div class="row main">
				...
				<h5></h5>
					<form onsubmit="return input_check_func()" class="" method="post" action="<%=path %>/hotelupdate.JejuTravel">
...
//회원가입 폼 전체를 채우도록 만들기 위한 기능
 function input_check_func() {
    ...
    if(address == null || name == null || bHours== null || food == null || holiday == null || groupf == null ||  
     address == ""   || name == ""   || bHours== "" || food == "" || holiday == "" || groupf == "") {
        alert("전부다 적어 주세요!");
        return false;
    } else {
