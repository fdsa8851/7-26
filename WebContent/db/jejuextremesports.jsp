	...
	<body>
		...
		<div class="container">
			<div class="row main">
				...
				<h5></h5>
					<form onsubmit="return input_check_func()" class="" method="post" action="<%=path %>/extremesportsupdate.JejuTravel">
						...
						<div class="form-group">
							<label for="password" class="cols-sm-2 control-label" >experience</label>
							<div class="cols-sm-10">
								<div class="input-group">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="holiday" id="holiday"   placeholder="holiday"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							<label for="confirm" class="cols-sm-2 control-label">price</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="groupf" id="groupf"   placeholder="groupf"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							<label for="confirm" class="cols-sm-2 control-label">webaddress</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
									<input type="text" class="form-control" name="webaddress" id="webaddress"   placeholder="webaddress"/>
								</div>
							</div>
						</div>

						<div class="form-group ">
							<input type="submit" id="button" name="signup"  class="form-control" value="db넣기">
						</div>
						
						
						<div class ="form-group">
							<button type="button" class="form-control" onclick="location.href='admin.JejuTravel'">뒤로가기</button>
						</div>
...
//회원가입 폼 전체를 채우도록 만들기 위한 기능
 function input_check_func() {
    ...
    var groupf = document.getElementById('groupf').value;
    var webaddress= document.getElementById('webaddress').value;
    
    if(address == null || name == null || bHours == null || experience == null || holiday == null || price == null || groupf == null || webaddress == null || 
     address == ""   || name == ""   || bHours == "" || experience== "" || holiday== "" || price== "" || groupf== "" || webaddress== "") {
        alert("전부다 적어 주세요!");
        return false;
    } else {
