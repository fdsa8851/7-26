	...
	<body>
		...
		<div class="container">
			<div class="row main">
				...
				<h5></h5>
					<form onsubmit="return input_check_func()" class="" method="post" action="<%=path %>/beachupdate.JejuTravel">
						...
						<div class="form-group ">
							<input type="submit" id="button" name="signup"  class="form-control" value="db저장">
						</div>
					</form>
