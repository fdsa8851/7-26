...
/**
 * Servlet implementation class HotelFoodUpdateInfoServlet
 */
@WebServlet("/HotelFoodUpdateInfoServlet")
public class HotelFoodUpdateInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HotelFoodUpdateInfoServlet() {
        super();
