...
/**
 * Servlet implementation class HotelFoodGetInfoServlet
 */
@WebServlet("/HotelFoodGetInfoServlet")
public class HotelFoodGetInfoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HotelFoodGetInfoServlet() {
        super();
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		...
		try {
			HotelVO vo = HotelDAO.getHotelInfo(u_idx);
